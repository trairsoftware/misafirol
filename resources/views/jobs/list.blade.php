                    ...
                    <div>
                        @isset(\Illuminate\Support\Facades\Auth::user()->type)
                            @if(\Illuminate\Support\Facades\Auth::user()->type === 'guest')
                                <a type="button" class="btn btn-danger text-white" href="{{url('jobs/add')}}">
                                    İlan Oluştur
                                </a>
                            @endif
                        @endisset()
                                ...
                                @foreach($jobs as $job)
                                    <tr>
                                        @isset(Auth::user()->type)
                                            ...
                                            <th scope="col">{{$job->phone_number}}</th>
                                            @endif
                                        @endisset
                                    ...
                                    <td scope="row">
                                        ...
                                        <td scope="row">
                                            <a class="btn btn-primary" href="{{ url('jobs/request/get/' . $job->id ) }}">
                                                Başvurular
                                            </a>

                                            <a class="btn btn-danger" href="{{ url('neejobsd/close/' . $job->id ) }}">
                                                İlanı Kapat
                                            </a>
                                        </td>
                                    </tr>
