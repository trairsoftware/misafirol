                        ...
                        <div class="card-body">
                            @if (isset($action) && $action === 'edit')
                                <form method="POST" action="{{ url('need/edit/'. $ticket->id) }}"
                                    ...
                                    @method('PATCH')
                                    @else
                                        <form method="POST" action="{{ url('need/add') }}"
                                              enctype="multipart/form-data">
                                            @endif
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    @component('components.form.select', ['name' => 'need_type', 'label' => 'İhtiyaç Türü', 'options' => [['label' => 'Gıda', 'value' => 'Gıda'], ['label' => 'Giyim', 'value' => 'Giyim'], ['label' => 'Anne Bebek Ürünleri', 'value' => 'Anne Bebek Ürünleri'], ['label' => 'Ayakkabı', 'value' => 'Ayakkabı'], ['label' => 'Diğer', 'value' => 'Diğer']]])@endcomponent
