                    ...
                    <div>
                        @isset(\Illuminate\Support\Facades\Auth::user()->type)
                            @if(\Illuminate\Support\Facades\Auth::user()->type === 'guest')
                                <a type="button" class="btn btn-danger text-white" href="{{url('need/add')}}">
                                    İlan Oluştur
                                </a>
                            @endif
                        @endisset()
                            ...
                            @isset($needs)
                                @foreach($needs as $need)
                                    ...
                                    <td scope="row">
                                        ...
                                        <td scope="row">
                                            <a class="btn btn-primary" href="{{ url('need/request/get/' . $need->id ) }}">
                                                Başvurular
                                            </a>

                                            <a class="btn btn-danger" href="{{ url('need/close/' . $need->id ) }}">
                                                İlanı Kapat
                                            </a>
                                        </td>
                                    </tr>
